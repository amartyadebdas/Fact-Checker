...
English language. Your task is to take a dictionary and convert it into a blank dictionary which means the dictionary should have the same structure and the same keys 
...
Here is the dictionary you're supposed to work on:'''